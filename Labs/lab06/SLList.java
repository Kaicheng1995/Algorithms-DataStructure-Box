...
public class SLList {
    ...
    public void add(int index, int x) {
        // TODO
        if (index >= size) {
            IntListNode p = sentinel;                  // sentinel is a box of SLList, and always the first NODE at a list
            while (p.next != sentinel) {              // It's like a cursor!!!
                p = p.next;
            }
    ...
    public IntListNode reverseHelper(IntListNode p, IntListNode q) {
        if (p == null) {
            return q;
        }
